...
parser.add_argument('--finetune', dest='finetune', default=True, action='store_true',
...
def main():
    ...
    if args.resume:
        print("Resume from previous checkpoint.pth.tar.")
...
def train(train_loader, model, criterion, optimizer, epoch):
    ...
    for i, (input, target) in enumerate(train_loader):
        ...
        prec1, prec5 = accuracy(output.data, target, topk=(1, min(5, num_class)))
