...
VOC_OCR_DATA = "/home/hyer/Desktop/vocEval/VOC2007"
...
def convert_annotation(image_id):
    ...
    out_file = open(VOC_OCR_DATA + '/gt_txt/%s.txt'%image_id, 'a')
...
if os.path.exists(VOC_OCR_DATA + '/gt_txts'):
    shutil.rmtree(VOC_OCR_DATA + '/gt_txts')
os.mkdir(VOC_OCR_DATA + '/gt_txts')
