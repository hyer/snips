...
def draw_custom(coord_list, trace_file_path=None, image_h=224, image_w=416, canvas_h=400, canvas_w=800, line_width=2, pad = 30,
               image_name=None):
    '''
...
if __name__ == '__main__':
    ...
    with open(trace_file) as f:
        ...
        img, padding_w, padding_h, formule_traces = draw(formule_traces, image_name="traces.jpg")
